...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('h_salida', models.TimeField(auto_created=True, blank=True, null=True, verbose_name='Hora de salida')),
                ('fecha', models.DateField(auto_created=True, blank=True, null=True, verbose_name='Fecha')),
                ...
                ('h_entrada', models.TimeField(blank=True, null=True, verbose_name='ora de ingreso')),
            ],
            options={
