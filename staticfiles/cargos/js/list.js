        ...
        columnDefs:[
           
            {
                ...
                render:function(date,type,row){
                    var buttons = '<div class="d-flex justify-content-center"><a href="/erp/cargo/update/' + row.id + '/" class="btn btn-warning btn-sm "><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/erp/cargo/delete/' + row.id + '/" type="button" class="btn btn-danger btn-sm "><i class="fas fa-trash-alt"></i></a></div>';
                    return buttons;
                }
            }
        ],
                ...
                buttons: [
                    {
                        ...
                        action:function(e,dt,node,conf){
                            window.location.href = '/erp/cargo/create/'
                        }
                    },
